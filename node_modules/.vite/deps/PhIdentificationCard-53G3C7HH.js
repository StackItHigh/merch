...
var s2 = (e, o, p2, i) => {
  for (var t = i > 1 ? void 0 : i ? M(o, p2) : o, m = e.length - 1, Z; m >= 0; m--)
    (Z = e[m]) && (t = (i ? Z(o, p2, t) : Z(t)) || t);
  return i && t && c(o, p2, t), t;
};
...
a = s2([
  s("ph-identification-card")
], a);
export {
  a as PhIdentificationCard
};
//# sourceMappingURL=PhIdentificationCard-53G3C7HH.js.map
