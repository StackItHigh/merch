...
var r = (e, l, i, a) => {
  for (var c = a > 1 ? void 0 : a ? f(l, i) : l, p2 = e.length - 1, C; p2 >= 0; p2--)
    (C = e[p2]) && (c = (a ? C(l, i, c) : C(c)) || c);
...
var s2 = class extends n {
  ...
  render() {
    ...
    >
      ${s2.weightsMap.get((e = this.weight) != null ? e : "regular")}
    </svg>`;
  }
};
s2.weightsMap = /* @__PURE__ */ new Map([
  [
    "thin",
...
r([
  O({ type: String, reflect: true })
], s2.prototype, "weight", 2);
r([
  O({ type: String, reflect: true })
], s2.prototype, "color", 2);
r([
  O({ type: Boolean, reflect: true })
], s2.prototype, "mirrored", 2);
s2 = r([
  s("ph-seal-check")
], s2);
export {
...
//# sourceMappingURL=PhSealCheck-FELJZRZ2.js.map
