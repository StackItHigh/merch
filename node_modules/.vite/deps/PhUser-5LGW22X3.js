...
var a = (s2, o, l, i) => {
  for (var r = i > 1 ? void 0 : i ? M(o, l) : o, h = s2.length - 1, c; h >= 0; h--)
    (c = s2[h]) && (r = (i ? c(o, l, r) : c(r)) || r);
...
var t = class extends n {
  ...
  render() {
    ...
    >
      ${t.weightsMap.get((s2 = this.weight) != null ? s2 : "regular")}
    </svg>`;
  }
};
...
//# sourceMappingURL=PhUser-5LGW22X3.js.map
