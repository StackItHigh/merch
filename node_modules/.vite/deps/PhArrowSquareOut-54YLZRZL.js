...
var o = (e, s2, p2, h) => {
  for (var t = h > 1 ? void 0 : h ? c(s2, p2) : s2, l = e.length - 1, m; l >= 0; l--)
    (m = e[l]) && (t = (h ? m(s2, p2, t) : m(t)) || t);
  return h && t && g(s2, p2, t), t;
};
...
a = o([
  s("ph-arrow-square-out")
], a);
export {
  a as PhArrowSquareOut
};
//# sourceMappingURL=PhArrowSquareOut-54YLZRZL.js.map
