...
function __decorate(decorators, target, key, desc) {
  var c5 = arguments.length, r3 = c5 < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d4;
  if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r3 = Reflect.decorate(decorators, target, key, desc);
  else for (var i3 = decorators.length - 1; i3 >= 0; i3--) if (d4 = decorators[i3]) r3 = (c5 < 3 ? d4(r3) : c5 > 3 ? d4(target, key, r3) : d4(target, key)) || r3;
...
function __generator(thisArg, body) {
  ...
  function step(op) {
    ...
    while (_3) try {
      if (f4 = 1, y3 && (t = op[0] & 2 ? y3["return"] : op[0] ? y3["throw"] || ((t = y3["return"]) && t.call(y3), 0) : y3.next) && !(t = t.call(y3, op[1])).done) return t;
...
function __createBinding(o5, m3, k4, k22) {
...
function __spreadArrays() {
  ...
  for (var r3 = Array(s3), k4 = 0, i3 = 0; i3 < il; i3++)
    for (var a2 = arguments[i3], j4 = 0, jl = a2.length; j4 < jl; j4++, k4++)
      r3[k4] = a2[j4];
  return r3;
}
function __await(v4) {
...
function __createBinding2(o5, m3, k4, k22) {
  if (k22 === void 0) k22 = k4;
  o5[k22] = m3[k4];
}
...
function k(r3) {
  return g(i({}, r3), { level: r3?.level || c.level });
}
function v(r3, e2 = n) {
  return r3[e2] || "";
}
...
function Cn(t, e2, n4, r3) {
  ...
  const o5 = BigInt(32), s3 = BigInt(4294967295), a2 = Number(n4 >> o5 & s3), u = Number(n4 & s3), i3 = r3 ? 4 : 0, D2 = r3 ? 0 : 4;
  t.setUint32(e2 + i3, a2, r3), t.setUint32(e2 + D2, u, r3);
}
var An = class extends xn {
  ...
  digestInto(e2) {
    ...
    for (let l6 = a2; l6 < o5; l6++) n4[l6] = 0;
    ...
    const D2 = i3 / 4, c5 = this.get();
    if (D2 > c5.length) throw new Error("_sha2: outputLen bigger than state");
    for (let l6 = 0; l6 < D2; l6++) u.setUint32(4 * l6, c5[l6], s3);
  }
  digest() {
...
var Jn = class extends An {
  ...
  get() {
    const { Ah: e2, Al: n4, Bh: r3, Bl: o5, Ch: s3, Cl: a2, Dh: u, Dl: i3, Eh: D2, El: c5, Fh: l6, Fl: p3, Gh: w4, Gl: h4, Hh: g4, Hl: S2 } = this;
    return [e2, n4, r3, o5, s3, a2, u, i3, D2, c5, l6, p3, w4, h4, g4, S2];
  }
  set(e2, n4, r3, o5, s3, a2, u, i3, D2, c5, l6, p3, w4, h4, g4, S2) {
    this.Ah = e2 | 0, this.Al = n4 | 0, this.Bh = r3 | 0, this.Bl = o5 | 0, this.Ch = s3 | 0, this.Cl = a2 | 0, this.Dh = u | 0, this.Dl = i3 | 0, this.Eh = D2 | 0, this.El = c5 | 0, this.Fh = l6 | 0, this.Fl = p3 | 0, this.Gh = w4 | 0, this.Gl = h4 | 0, this.Hh = g4 | 0, this.Hl = S2 | 0;
  }
  process(e2, n4) {
    for (let d4 = 0; d4 < 16; d4++, n4 += 4) P[d4] = e2.getUint32(n4), Q[d4] = e2.getUint32(n4 += 4);
    for (let d4 = 16; d4 < 80; d4++) {
      const m3 = P[d4 - 15] | 0, F = Q[d4 - 15] | 0, q = x2.rotrSH(m3, F, 1) ^ x2.rotrSH(m3, F, 8) ^ x2.shrSH(m3, F, 7), z3 = x2.rotrSL(m3, F, 1) ^ x2.rotrSL(m3, F, 8) ^ x2.shrSL(m3, F, 7), I2 = P[d4 - 2] | 0, O4 = Q[d4 - 2] | 0, ot = x2.rotrSH(I2, O4, 19) ^ x2.rotrBH(I2, O4, 61) ^ x2.shrSH(I2, O4, 6), tt = x2.rotrSL(I2, O4, 19) ^ x2.rotrBL(I2, O4, 61) ^ x2.shrSL(I2, O4, 6), st = x2.add4L(z3, tt, Q[d4 - 7], Q[d4 - 16]), at = x2.add4H(st, q, ot, P[d4 - 7], P[d4 - 16]);
      P[d4] = at | 0, Q[d4] = st | 0;
    }
    let { Ah: r3, Al: o5, Bh: s3, Bl: a2, Ch: u, Cl: i3, Dh: D2, Dl: c5, Eh: l6, El: p3, Fh: w4, Fl: h4, Gh: g4, Gl: S2, Hh: v4, Hl: L3 } = this;
    for (let d4 = 0; d4 < 80; d4++) {
      const m3 = x2.rotrSH(l6, p3, 14) ^ x2.rotrSH(l6, p3, 18) ^ x2.rotrBH(l6, p3, 41), F = x2.rotrSL(l6, p3, 14) ^ x2.rotrSL(l6, p3, 18) ^ x2.rotrBL(l6, p3, 41), q = l6 & w4 ^ ~l6 & g4, z3 = p3 & h4 ^ ~p3 & S2, I2 = x2.add5L(L3, F, z3, Yn[d4], Q[d4]), O4 = x2.add5H(I2, v4, m3, q, Vn[d4], P[d4]), ot = I2 | 0, tt = x2.rotrSH(r3, o5, 28) ^ x2.rotrBH(r3, o5, 34) ^ x2.rotrBH(r3, o5, 39), st = x2.rotrSL(r3, o5, 28) ^ x2.rotrBL(r3, o5, 34) ^ x2.rotrBL(r3, o5, 39), at = r3 & s3 ^ r3 & u ^ s3 & u, Ct = o5 & a2 ^ o5 & i3 ^ a2 & i3;
      v4 = g4 | 0, L3 = S2 | 0, g4 = w4 | 0, S2 = h4 | 0, w4 = l6 | 0, h4 = p3 | 0, { h: l6, l: p3 } = x2.add(D2 | 0, c5 | 0, O4 | 0, ot | 0), D2 = u | 0, c5 = i3 | 0, u = s3 | 0, i3 = a2 | 0, s3 = r3 | 0, a2 = o5 | 0;
      const At = x2.add3L(ot, st, Ct);
      r3 = x2.add3H(At, O4, tt, at), o5 = At | 0;
    }
    ({ h: r3, l: o5 } = x2.add(this.Ah | 0, this.Al | 0, r3 | 0, o5 | 0)), { h: s3, l: a2 } = x2.add(this.Bh | 0, this.Bl | 0, s3 | 0, a2 | 0), { h: u, l: i3 } = x2.add(this.Ch | 0, this.Cl | 0, u | 0, i3 | 0), { h: D2, l: c5 } = x2.add(this.Dh | 0, this.Dl | 0, D2 | 0, c5 | 0), { h: l6, l: p3 } = x2.add(this.Eh | 0, this.El | 0, l6 | 0, p3 | 0), { h: w4, l: h4 } = x2.add(this.Fh | 0, this.Fl | 0, w4 | 0, h4 | 0), { h: g4, l: S2 } = x2.add(this.Gh | 0, this.Gl | 0, g4 | 0, S2 | 0), { h: v4, l: L3 } = x2.add(this.Hh | 0, this.Hl | 0, v4 | 0, L3 | 0), this.set(r3, o5, s3, a2, u, i3, D2, c5, l6, p3, w4, h4, g4, S2, v4, L3);
  }
  roundClean() {
    P.fill(0), Q.fill(0);
  }
...
function Ae(t, e2) {
  ...
  for (; n4 !== M; ) {
    const u = r3 / n4, i3 = r3 % n4, D2 = o5 - s3 * u;
    r3 = n4, n4 = i3, o5 = s3, s3 = D2;
  }
...
function sr(t) {
  ...
  if (r3 === 1) {
    ...
    return function(i3, D2) {
      const c5 = i3.pow(D2, a2);
      if (!i3.eql(i3.sqr(c5), D2)) throw new Error("Cannot find square root");
      return c5;
    };
  }
  const s3 = (n4 + N) / nt;
  return function(u, i3) {
    ...
    let D2 = r3, c5 = u.pow(u.mul(u.ONE, o5), n4), l6 = u.pow(i3, s3), p3 = u.pow(i3, n4);
    for (; !u.eql(p3, u.ONE); ) {
      if (u.eql(p3, u.ZERO)) return u.ZERO;
      let w4 = 1;
      for (let g4 = u.sqr(p3); w4 < D2 && !u.eql(g4, u.ONE); w4++) g4 = u.sqr(g4);
      const h4 = u.pow(c5, N << BigInt(D2 - w4 - 1));
      c5 = u.sqr(h4), l6 = u.mul(l6, h4), p3 = u.mul(p3, c5), D2 = w4;
    }
    return l6;
  };
}
function ir(t) {
  ...
  if (t % Ce === Be) {
    const e2 = (t - Be) / Ce;
    return function(r3, o5) {
      const s3 = r3.mul(o5, nt), a2 = r3.pow(s3, e2), u = r3.mul(o5, a2), i3 = r3.mul(r3.mul(u, nt), a2), D2 = r3.mul(u, r3.sub(i3, r3.ONE));
...
function _e(t, e2, n4 = false, r3 = {}) {
  ...
  const u = Object.freeze({ ORDER: t, isLE: n4, BITS: o5, BYTES: s3, MASK: er(o5), ZERO: M, ONE: N, create: (i3) => H(i3, t), isValid: (i3) => {
    ...
    return M <= i3 && i3 < t;
  }, is0: (i3) => i3 === M, isOdd: (i3) => (i3 & N) === N, neg: (i3) => H(-i3, t), eql: (i3, D2) => i3 === D2, sqr: (i3) => H(i3 * i3, t), add: (i3, D2) => H(i3 + D2, t), sub: (i3, D2) => H(i3 - D2, t), mul: (i3, D2) => H(i3 * D2, t), pow: (i3, D2) => fr(u, i3, D2), div: (i3, D2) => H(i3 * Ae(D2, t), t), sqrN: (i3) => i3 * i3, addN: (i3, D2) => i3 + D2, subN: (i3, D2) => i3 - D2, mulN: (i3, D2) => i3 * D2, inv: (i3) => Ae(i3, t), sqrt: r3.sqrt || ((i3) => (a2 || (a2 = ir(t)), a2(u, i3))), invertBatch: (i3) => Dr(u, i3), cmov: (i3, D2, c5) => c5 ? D2 : i3, toBytes: (i3) => n4 ? Nt(i3, s3) : ge(i3, s3), fromBytes: (i3) => {
...
function lr(t, e2) {
  return { constTimeNegate: zt, hasPrecomputes(n4) {
    ...
    for (let D2 = 0; D2 < o5; D2++) {
      i3 = u, a2.push(i3);
      for (let c5 = 1; c5 < s3; c5++) i3 = i3.add(u), a2.push(i3);
      u = i3.double();
    }
    return a2;
  }, wNAF(n4, r3, o5) {
    ...
    const D2 = BigInt(2 ** n4 - 1), c5 = 2 ** n4, l6 = BigInt(n4);
    for (let p3 = 0; p3 < s3; p3++) {
      const w4 = p3 * a2;
      let h4 = Number(o5 & D2);
      o5 >>= l6, h4 > a2 && (h4 -= c5, o5 += gt);
      const g4 = w4, S2 = w4 + Math.abs(h4) - 1, v4 = p3 % 2 !== 0, L3 = h4 < 0;
      h4 === 0 ? i3 = i3.add(zt(v4, r3[g4])) : u = u.add(zt(L3, r3[S2]));
    }
    return { p: u, f: i3 };
  }, wNAFUnsafe(n4, r3, o5, s3 = t.ZERO) {
    const { windows: a2, windowSize: u } = Mt(n4, e2), i3 = BigInt(2 ** n4 - 1), D2 = 2 ** n4, c5 = BigInt(n4);
    for (let l6 = 0; l6 < a2; l6++) {
      const p3 = l6 * u;
      if (o5 === Se) break;
      let w4 = Number(o5 & i3);
      if (o5 >>= c5, w4 > u && (w4 -= D2, o5 += gt), w4 === 0) continue;
      let h4 = r3[p3 + Math.abs(w4) - 1];
      w4 < 0 && (h4 = h4.negate()), s3 = s3.add(h4);
    }
    return s3;
...
function br(t, e2, n4, r3) {
  ...
  const o5 = t.ZERO, s3 = tr(BigInt(n4.length)), a2 = s3 > 12 ? s3 - 3 : s3 > 4 ? s3 - 2 : s3 ? 2 : 1, u = (1 << a2) - 1, i3 = new Array(u + 1).fill(o5), D2 = Math.floor((e2.BITS - 1) / a2) * a2;
  let c5 = o5;
  for (let l6 = D2; l6 >= 0; l6 -= a2) {
    i3.fill(o5);
    for (let w4 = 0; w4 < r3.length; w4++) {
      const h4 = r3[w4], g4 = Number(h4 >> BigInt(l6) & BigInt(u));
      i3[g4] = i3[g4].add(n4[w4]);
    }
    let p3 = o5;
    for (let w4 = i3.length - 1, h4 = o5; w4 > 0; w4--) h4 = h4.add(i3[w4]), p3 = p3.add(h4);
    if (c5 = c5.add(p3), l6 !== 0) for (let w4 = 0; w4 < a2; w4++) c5 = c5.double();
  }
  return c5;
}
function pr(t) {
...
function yr(t) {
  const e2 = gr(t), { Fp: n4, n: r3, prehash: o5, hash: s3, randomBytes: a2, nByteLength: u, h: i3 } = e2, D2 = yt << BigInt(u * 8) - j, c5 = n4.create, l6 = _e(e2.n, e2.nBitLength), p3 = e2.uvRatio || ((y3, f4) => {
    try {
      return { isValid: true, value: n4.sqrt(y3 * n4.inv(f4)) };
    } catch {
      return { isValid: false, value: G };
    }
  }), w4 = e2.adjustScalarBytes || ((y3) => y3), h4 = e2.domain || ((y3, f4, b3) => {
    if (Tt("phflag", b3), f4.length || b3) throw new Error("Contexts/pre-hash are not supported");
    return y3;
  });
  function g4(y3, f4) {
    ft("coordinate " + y3, f4, G, D2);
  }
  function S2(y3) {
    if (!(y3 instanceof d4)) throw new Error("ExtendedPoint expected");
  }
  const v4 = xe((y3, f4) => {
    const { ex: b3, ey: E4, ez: B2 } = y3, C3 = y3.is0();
    f4 == null && (f4 = C3 ? wr : n4.inv(B2));
    const A2 = c5(b3 * f4), U2 = c5(E4 * f4), _3 = c5(B2 * f4);
    ...
    const { ex: E4, ey: B2, ez: C3, et: A2 } = y3, U2 = c5(E4 * E4), _3 = c5(B2 * B2), T3 = c5(C3 * C3), $ = c5(T3 * T3), R = c5(U2 * f4), V = c5(T3 * c5(R + _3)), Y = c5($ + c5(b3 * c5(U2 * _3)));
    if (V !== Y) throw new Error("bad point: equation left != right (1)");
    const Z = c5(E4 * B2), X = c5(C3 * A2);
    if (Z !== X) throw new Error("bad point: equation left != right (2)");
    return true;
  });
  class d4 {
    constructor(f4, b3, E4, B2) {
      this.ex = f4, this.ey = b3, this.ez = E4, this.et = B2, g4("x", f4), g4("y", b3), g4("z", E4), g4("t", B2), Object.freeze(this);
    }
    get x() {
    ...
    static fromAffine(f4) {
      ...
      const { x: b3, y: E4 } = f4 || {};
      return g4("x", b3), g4("y", E4), new d4(b3, E4, j, c5(b3 * E4));
    }
    static normalizeZ(f4) {
      const b3 = n4.invertBatch(f4.map((E4) => E4.ez));
      return f4.map((E4, B2) => E4.toAffine(b3[B2])).map(d4.fromAffine);
    }
    static msm(f4, b3) {
      return br(d4, l6, f4, b3);
    }
    _setWindowSize(f4) {
    ...
    equals(f4) {
      S2(f4);
      const { ex: b3, ey: E4, ez: B2 } = this, { ex: C3, ey: A2, ez: U2 } = f4, _3 = c5(b3 * U2), T3 = c5(C3 * B2), $ = c5(E4 * U2), R = c5(A2 * B2);
      return _3 === T3 && $ === R;
    }
    is0() {
    ...
    negate() {
      return new d4(c5(-this.ex), this.ey, this.ez, c5(-this.et));
    }
    double() {
      const { a: f4 } = e2, { ex: b3, ey: E4, ez: B2 } = this, C3 = c5(b3 * b3), A2 = c5(E4 * E4), U2 = c5(yt * c5(B2 * B2)), _3 = c5(f4 * C3), T3 = b3 + E4, $ = c5(c5(T3 * T3) - C3 - A2), R = _3 + A2, V = R - U2, Y = _3 - A2, Z = c5($ * V), X = c5(R * Y), et = c5($ * Y), pt = c5(V * R);
      return new d4(Z, X, pt, et);
    }
    add(f4) {
      S2(f4);
      const { a: b3, d: E4 } = e2, { ex: B2, ey: C3, ez: A2, et: U2 } = this, { ex: _3, ey: T3, ez: $, et: R } = f4;
      if (b3 === BigInt(-1)) {
        const re = c5((C3 - B2) * (T3 + _3)), oe = c5((C3 + B2) * (T3 - _3)), mt = c5(oe - re);
      ...
      const V = c5(B2 * _3), Y = c5(C3 * T3), Z = c5(U2 * E4 * R), X = c5(A2 * $), et = c5((B2 + C3) * (_3 + T3) - V - Y), pt = X - Z, ee = X + Z, ne = c5(Y - b3 * V), un = c5(et * pt), cn = c5(ee * ne), an = c5(et * ne), fn = c5(pt * ee);
    ...
    multiply(f4) {
      const b3 = f4;
      ft("scalar", b3, j, r3);
      const { p: E4, f: B2 } = this.wNAF(b3);
      return d4.normalizeZ([E4, B2])[0];
    }
    multiplyUnsafe(f4, b3 = d4.ZERO) {
      const E4 = f4;
      return ft("scalar", E4, G, r3), E4 === G ? F : this.is0() || E4 === j ? this : q.wNAFCachedUnsafe(this, E4, d4.normalizeZ, b3);
    }
    isSmallOrder() {
    ...
    static fromHex(f4, b3 = false) {
      const { d: E4, a: B2 } = e2, C3 = n4.BYTES;
      f4 = W("pointHex", f4, C3), Tt("zip215", b3);
      const A2 = f4.slice(), U2 = f4[C3 - 1];
      A2[C3 - 1] = U2 & -129;
      const _3 = Et(A2), T3 = b3 ? D2 : n4.ORDER;
      ...
      return et !== X && (Z = c5(-Z)), d4.fromAffine({ x: Z, y: _3 });
    }
    static fromPrivateKey(f4) {
      return O4(f4).point;
    }
    toRawBytes() {
      const { x: f4, y: b3 } = this.toAffine(), E4 = Nt(b3, n4.BYTES);
      return E4[E4.length - 1] |= f4 & j ? 128 : 0, E4;
    }
    toHex() {
      return Ft(this.toRawBytes());
    }
  }
  d4.BASE = new d4(e2.Gx, e2.Gy, j, c5(e2.Gx * e2.Gy)), d4.ZERO = new d4(G, j, j, G);
  ...
  function O4(y3) {
    const f4 = n4.BYTES;
    y3 = W("private key", y3, f4);
    const b3 = W("hashed private key", s3(y3), 2 * f4), E4 = w4(b3.slice(0, f4)), B2 = b3.slice(f4, 2 * f4), C3 = I2(E4), A2 = m3.multiply(C3), U2 = A2.toRawBytes();
    return { head: E4, prefix: B2, scalar: C3, point: A2, pointBytes: U2 };
  }
  function ot(y3) {
    return O4(y3).pointBytes;
  }
  function tt(y3 = new Uint8Array(), ...f4) {
    const b3 = ye(...f4);
    return I2(s3(h4(b3, W("context", y3), !!o5)));
  }
  function st(y3, f4, b3 = {}) {
    y3 = W("message", y3), o5 && (y3 = o5(y3));
    const { prefix: E4, scalar: B2, pointBytes: C3 } = O4(f4), A2 = tt(b3.context, E4, y3), U2 = m3.multiply(A2).toRawBytes(), _3 = tt(b3.context, U2, C3, y3), T3 = z3(A2 + _3 * B2);
    ft("signature.s", T3, G, r3);
    const $ = ye(U2, Nt(T3, n4.BYTES));
    return W("result", $, n4.BYTES * 2);
  }
  const at = Er;
  function Ct(y3, f4, b3, E4 = at) {
    const { context: B2, zip215: C3 } = E4, A2 = n4.BYTES;
    y3 = W("signature", y3, 2 * A2), f4 = W("message", f4), b3 = W("publicKey", b3, A2), C3 !== void 0 && Tt("zip215", C3), o5 && (f4 = o5(f4));
    const U2 = Et(y3.slice(A2, 2 * A2));
    let _3, T3, $;
    try {
      _3 = d4.fromHex(b3, C3), T3 = d4.fromHex(y3.slice(0, A2), C3), $ = m3.multiplyUnsafe(U2);
    } catch {
      return false;
    }
    if (!C3 && _3.isSmallOrder()) return false;
    const R = tt(B2, T3.toRawBytes(), _3.toRawBytes(), f4);
    return T3.add(_3.multiplyUnsafe(R)).subtract($).clearCofactor().equals(d4.ZERO);
  }
  return m3._setWindowSize(8), { CURVE: e2, getPublicKey: ot, sign: st, verify: Ct, ExtendedPoint: d4, utils: { getExtendedPublicKey: O4, randomPrivateKey: () => a2(n4.BYTES), precompute(y3 = 8, f4 = d4.BASE) {
    return f4._setWindowSize(y3), f4.multiply(BigInt(3)), f4;
  } } };
}
BigInt(0), BigInt(1);
...
var Cr = BigInt(8);
function Ar(t) {
  const e2 = BigInt(10), n4 = BigInt(20), r3 = BigInt(40), o5 = BigInt(80), s3 = kt, u = t * t % s3 * t % s3, i3 = J(u, Te, s3) * u % s3, D2 = J(i3, xr, s3) * t % s3, c5 = J(D2, Br, s3) * D2 % s3, l6 = J(c5, e2, s3) * c5 % s3, p3 = J(l6, n4, s3) * l6 % s3, w4 = J(p3, r3, s3) * p3 % s3, h4 = J(w4, o5, s3) * w4 % s3, g4 = J(h4, o5, s3) * w4 % s3, S2 = J(g4, e2, s3) * c5 % s3;
...
function _r(t, e2) {
  ...
  let a2 = H(t * r3 * s3, n4);
  const u = H(e2 * a2 * a2, n4), i3 = a2, D2 = H(a2 * Ue, n4), c5 = u === t, l6 = u === H(-t, n4), p3 = u === H(-t * Ue, n4);
  return c5 && (a2 = i3), (l6 || p3) && (a2 = D2), ur(a2, n4) && (a2 = H(-a2, n4)), { isValid: c5 || l6, value: a2 };
}
...
function Ir(t, e2) {
  ...
  var u = t.length, i3 = t.charAt(0), D2 = Math.log(u) / Math.log(256), c5 = Math.log(256) / Math.log(u);
  function l6(h4) {
    ...
    for (var g4 = 0, S2 = 0, v4 = 0, L3 = h4.length; v4 !== L3 && h4[v4] === 0; ) v4++, g4++;
    for (var d4 = (L3 - v4) * c5 + 1 >>> 0, m3 = new Uint8Array(d4); v4 !== L3; ) {
      for (var F = h4[v4], q = 0, z3 = d4 - 1; (F !== 0 || q < S2) && z3 !== -1; z3--, q++) F += 256 * m3[z3] >>> 0, m3[z3] = F % u >>> 0, F = F / u >>> 0;
      if (F !== 0) throw new Error("Non-zero carry");
      S2 = q, v4++;
    }
    for (var I2 = d4 - S2; I2 !== d4 && m3[I2] === 0; ) I2++;
    for (var O4 = i3.repeat(g4); I2 < d4; ++I2) O4 += t.charAt(m3[I2]);
    return O4;
  }
  function p3(h4) {
    ...
    var g4 = 0;
    if (h4[g4] !== " ") {
      for (var S2 = 0, v4 = 0; h4[g4] === i3; ) S2++, g4++;
      for (var L3 = (h4.length - g4) * D2 + 1 >>> 0, d4 = new Uint8Array(L3); h4[g4]; ) {
        var m3 = n4[h4.charCodeAt(g4)];
        if (m3 === 255) return;
      ...
      if (h4[g4] !== " ") {
        for (var z3 = L3 - v4; z3 !== L3 && d4[z3] === 0; ) z3++;
        for (var I2 = new Uint8Array(S2 + (L3 - z3)), O4 = S2; z3 !== L3; ) I2[O4++] = d4[z3++];
        return I2;
      }
    }
  }
  ...
  return { encode: l6, decodeUnsafe: p3, decode: w4 };
}
var Ur = Ir;
var Tr = Ur;
var He = (t) => {
...
var Mr = (t, e2, n4, r3) => {
  ...
  let u = 0, i3 = 0, D2 = 0;
  for (let c5 = 0; c5 < s3; ++c5) {
    const l6 = o5[t[c5]];
    if (l6 === void 0) throw new SyntaxError(`Non-${r3} character`);
    i3 = i3 << n4 | l6, u += n4, u >= 8 && (u -= 8, a2[D2++] = 255 & i3 >> u);
  }
...
var k2 = ({ name: t, prefix: e2, bitsPerChar: n4, alphabet: r3 }) => Bt({ prefix: e2, name: t, encode(o5) {
  return qr(o5, r3, n4);
}, decode(o5) {
...
async function Qo(t, e2, n4, r3, o5 = (0, import_time.fromMiliseconds)(Date.now())) {
  const s3 = { alg: jt, typ: Zt }, a2 = Qe(r3.publicKey), u = o5 + n4, i3 = { iss: a2, sub: t, aud: e2, iat: o5, exp: u }, D2 = rn({ header: s3, payload: i3 }), c5 = Rt.sign(D2, r3.secretKey.slice(0, 32));
  return on({ header: s3, payload: i3, signature: c5 });
}

// node_modules/detect-browser/es/index.js
var __spreadArray = function(to2, from3, pack) {
  if (pack || arguments.length === 2) for (var i3 = 0, l6 = from3.length, ar2; i3 < l6; i3++) {
    if (ar2 || !(i3 in from3)) {
      if (!ar2) ar2 = Array.prototype.slice.call(from3, 0, i3);
      ar2[i3] = from3[i3];
    }
  }
...
function base(ALPHABET2) {
  ...
  for (let i3 = 0; i3 < ALPHABET2.length; i3++) {
    const x4 = ALPHABET2.charAt(i3);
    const xc = x4.charCodeAt(0);
    if (BASE_MAP[xc] !== 255) {
  ...
  function encode5(source) {
    ...
    while (pbegin !== pend) {
      ...
      let i3 = 0;
      for (let it1 = size - 1; (carry !== 0 || i3 < length2) && it1 !== -1; it1--, i3++) {
        carry += 256 * b58[it1] >>> 0;
  ...
  function decodeUnsafe(source) {
    ...
    while (psz < source.length) {
      ...
      let i3 = 0;
      for (let it3 = size - 1; (carry !== 0 || i3 < length2) && it3 !== -1; it3--, i3++) {
...
var i2 = class _i extends n3 {
  constructor(e2) {
    super(e2), this.events = new import_events3.EventEmitter(), this.interval = s2, this.interval = e2?.interval || s2;
  }
...
var z2 = (i3 = {}) => {
  ...
  let n4;
  return i3.dbName && i3.storeName && (n4 = createStore(i3.dbName, i3.storeName)), { name: x3, options: i3, async hasItem(s3) {
...
var O3 = async (i3, t, e2) => {
  const n4 = N2, s3 = await t.getItem(n4);
  if (s3 && s3 >= y2) {
    e2(t);
    return;
  }
  ...
  await t.setItem(n4, y2), e2(t), j3(i3, m3);
};
var j3 = async (i3, t) => {
...
function read(buf, offset) {
  var res = 0, offset = offset || 0, shift = 0, counter = offset, b3, l6 = buf.length;
  do {
    if (counter >= l6) {
      read.bytes = 0;
...
*/
//# sourceMappingURL=chunk-3BIZY2L4.js.map
