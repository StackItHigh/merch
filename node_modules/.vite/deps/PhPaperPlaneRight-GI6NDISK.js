...
var l = (a, o, i, s2) => {
  for (var e = s2 > 1 ? void 0 : s2 ? f(o, i) : o, h = a.length - 1, n2; h >= 0; h--)
    (n2 = a[h]) && (e = (s2 ? n2(o, i, e) : n2(e)) || e);
  return s2 && e && c(o, i, e), e;
};
...
t = l([
  s("ph-paper-plane-right")
], t);
export {
  t as PhPaperPlaneRight
};
//# sourceMappingURL=PhPaperPlaneRight-GI6NDISK.js.map
