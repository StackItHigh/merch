...
var l = (a, o, p2, s2) => {
  for (var r = s2 > 1 ? void 0 : s2 ? u(o, p2) : o, h = a.length - 1, m; h >= 0; h--)
    (m = a[h]) && (r = (s2 ? m(o, p2, r) : m(r)) || r);
  return s2 && r && c(o, p2, r), r;
};
...
t = l([
  s("ph-arrows-left-right")
], t);
export {
  t as PhArrowsLeftRight
};
//# sourceMappingURL=PhArrowsLeftRight-KVNUJ5QW.js.map
