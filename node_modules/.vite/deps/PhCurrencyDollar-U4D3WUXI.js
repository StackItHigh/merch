...
var e = (r, o, p2, s2) => {
  for (var t = s2 > 1 ? void 0 : s2 ? g(o, p2) : o, l = r.length - 1, m; l >= 0; l--)
    (m = r[l]) && (t = (s2 ? m(o, p2, t) : m(t)) || t);
  return s2 && t && Z(o, p2, t), t;
};
...
h = e([
  s("ph-currency-dollar")
], h);
export {
  h as PhCurrencyDollar
};
//# sourceMappingURL=PhCurrencyDollar-U4D3WUXI.js.map
