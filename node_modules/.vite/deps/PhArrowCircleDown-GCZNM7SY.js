...
var l = (a, o, p2, s2) => {
  for (var r = s2 > 1 ? void 0 : s2 ? A(o, p2) : o, m = a.length - 1, h; m >= 0; m--)
    (h = a[m]) && (r = (s2 ? h(o, p2, r) : h(r)) || r);
  return s2 && r && w(o, p2, r), r;
};
...
t = l([
  s("ph-arrow-circle-down")
], t);
export {
  t as PhArrowCircleDown
};
//# sourceMappingURL=PhArrowCircleDown-GCZNM7SY.js.map
